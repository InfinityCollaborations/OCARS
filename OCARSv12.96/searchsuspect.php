...
Search by Name, Location or Crime <input type="text" name="q" value="Enter Search"/>
...
<table width="100%" border="0" cellspacing="1" cellpadding="1" >
             ...
             <tr>
			 <td class="style6"><div align="left" class="style9 style5 style4"><strong><a href="EditWanted.php?WantedId=<?php echo $Id;?>">Edit</a></strong></div></td>
