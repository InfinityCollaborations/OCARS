...
<body style="background-image:url('img/bg4.jpg');background-attachment:fixed">
   ...
   ?>
           ...
           <h2 align="center" class="style2">Missing Persons</h2>
		   You are here:<a href="home.php">Home</a> >><a href="Missing.php">Missing Persons</a> 
 <form name="form" action="searchmissing.php" method="get" align="right">
Search by Name(s) or Location<input type="text" name="q" placeholder="Search Missing" />
...
?>
           <table width="100%" border="0" cellspacing="0" cellpadding="0">
             ...
             <tr>
               ...
               <td width="8%" height="38"><span class="style9"><strong>Name:</strong></span></td>
               <td width="23%"><span class="style3"><strong><?php echo $Name;?></strong></span></td>
               <td width="14%"><span class="style9"><strong>Contact Person:</strong></span></td>
               <td width="36%"><span class="style3"><strong><?php echo $Contact_Person;?></strong></span></td>
             </tr>
             <tr>
               <td height="41"><span class="style9"><strong>Gender:</strong></span></td>
               <td><span class="style3"><strong><?php echo $Gender;?></strong></span></td>
               <td><span class="style9"><strong>Contact Address:</strong></span></td>
               <td><span class="style3"><strong><?php echo $Contact_Address;?></strong></span></td>
             </tr>
             <tr>
               <td height="40"><span class="style9"><strong>Height:</strong></span></td>
               <td><span class="style3"><strong><?php echo $Height;?></strong></span></td>
               <td><span class="style9"><strong>Contact City:</strong></span></td>
               <td><span class="style3"><strong><?php echo $Contact_City;?></strong></span></td>
             </tr>
             <tr>
               <td height="52"><span class="style9"><strong>Weight:</strong></span></td>
               <td><span class="style3"><strong><?php echo $Weight;?></strong></span></td>
               <td><span class="style9"><strong>Contact Mobile:</strong></span></td>
